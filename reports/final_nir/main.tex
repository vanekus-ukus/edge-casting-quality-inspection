...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{figures/quality_comparison_clean.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{figures/size_comparison_clean.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.86\textwidth]{figures/pareto_f1_size_clean.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.86\textwidth]{figures/latency_comparison_clean.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.86\textwidth]{figures/triage_summary_clean.png}
...
включается в репозиторий и скачивается отдельно. Репозиторий доступен по ссылке:
\url{https://github.com/vanekus-ukus/edge-casting-quality-inspection}. Основные
артефакты: clean split manifest, metrics, tables, exact TFLite FP32/INT8,
LaTeX/PDF НИР.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.72\textwidth]{figures/confusion_matrix_micro_int8_clean.png}
